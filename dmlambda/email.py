...
class DonatematesEmail(object):
    ...
    def send_campaign_created(self, campaign_id, secret_id):
        ...
        email_msg += u"\t\r\nKeep track of your campaign and share with your friends and followers here: https://donatemates.com/campaign.html?id={}. ".format(campaign_id)
        email_msg += u"\t\r\n  \t\r\nIf you want to cancel your campaign in the future, visit this link: https://donatemates.com/cancel.html?id={}&secret={}".format(campaign_id, secret_id)
